...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center" >
      ...
      <h1 class="logo mr-auto"><a href="index.php">WELCOME TO SPARKS BAKING SYSTEM</a></h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Better Solutions For Your Transaction</h1>
          <div class="d-lg-flex">
            <a data-toggle="collapse" data-target="#mydemo" class="btn-get-started scrollto">Transaction Table</a>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>This helps to improve transaction securely. The users have to recall their
registered indexes and then give the numbers present in
those registered indexes in the same order. This password is
verified and then only they are allowed to enter into the next
transaction phase.</p>
        </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-left">
            ...
            <p> click the right side button to get all the details of the users </p>
          </div>
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" data-toggle="collapse" data-target="#demo" href="">User Details</a>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p> The sparks banking system <br/> email-sparks@gmail.com <br/> ph no-9815342040 </p>
